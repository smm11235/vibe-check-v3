...
export function DoneScreen({ result, onRestart }: DoneScreenProps) {
	...
	return (
		...
		>
			...
			>
				<h2 className="font-display text-[44px] leading-[1.1] text-accent mb-6">
					Your vibe is set
				</h2>
			</motion.div>
			...
			>
				...
				<h3 className="font-display text-[28px] text-text mt-2 mb-1">
					{comboType.name}
				</h3>
				<p className="font-body text-[17px] text-text-secondary">
					{comboType.tagline}
				</p>
			</motion.div>
